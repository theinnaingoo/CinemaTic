...
public class MGaMone extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mga_mone);
    ...
    public void call(){
        ...
        phone1.setText("09779054671");
        phone2.setText("09779054672");
        ...
        call1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (ActivityCompat.checkSelfPermission(getApplicationContext(),
                    ...
                    callIntent.setData(Uri.parse("tel:09779054671"));
        ...
        call2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (ActivityCompat.checkSelfPermission(getApplicationContext(),
                        Manifest.permission.CALL_PHONE) == PackageManager.PERMISSION_GRANTED) {
                    Intent callIntent = new Intent(Intent.ACTION_CALL);
                    callIntent.setData(Uri.parse("tel:09779054672"));
                    startActivity(callIntent);
                }else{
                    Toast.makeText(getApplicationContext(), "You don't assign permission.", Toast.LENGTH_SHORT).show();
                }
    ...
    public void map(){
        ...
        mapView.getMapAsync(new OnMapReadyCallback() {
            ...
            public void onMapReady(GoogleMap googleMap) {
                ...
                LatLng ny = new LatLng(16.8324507,96.1296734);
        ...
        cinname.setText(R.string.mgalo);
        dialog.show();
        dialog.setCanceledOnTouchOutside(true);
