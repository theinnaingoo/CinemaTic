...
public class MDagonCentre_II extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mdagon_centre__ii);
    ...
    public void call(){
        ...
        phone1.setText("0973254091");
        phone2.setText("0973254092");
        ...
        call1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (ActivityCompat.checkSelfPermission(getApplicationContext(),
                    ...
                    callIntent.setData(Uri.parse("tel:0973254091"));
        ...
        call2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (ActivityCompat.checkSelfPermission(getApplicationContext(),
                        Manifest.permission.CALL_PHONE) == PackageManager.PERMISSION_GRANTED) {
                    Intent callIntent = new Intent(Intent.ACTION_CALL);
                    callIntent.setData(Uri.parse("tel:0973254092"));
                    startActivity(callIntent);
                }else{
                    Toast.makeText(getApplicationContext(), "You don't assign permission.", Toast.LENGTH_SHORT).show();
                }
    ...
    public void map(){
        ...
        mapView.getMapAsync(new OnMapReadyCallback() {
            ...
            public void onMapReady(GoogleMap googleMap) {
                ...
                LatLng ny = new LatLng(16.7754553,96.1531924);
        ...
        cinname.setText(R.string.mdalo);
        dialog.show();
        dialog.setCanceledOnTouchOutside(true);
