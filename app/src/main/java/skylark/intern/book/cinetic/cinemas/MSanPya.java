...
public class MSanPya extends AppCompatActivity {

    FragmentManager fManager;
    FragmentTransaction fTransaction;
    //LayoutInflater inflater;
    String url= "https://www.google.com/maps/@19.9054437,96.274156,18z";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_msan_pya);
    ...
    public void call(){
        ...
        phone1.setText("09260887035");
        phone2.setText("09260887036");
        ...
        call1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (ActivityCompat.checkSelfPermission(getApplicationContext(),
                    ...
                    callIntent.setData(Uri.parse("tel:09260887035"));
        ...
        call2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (ActivityCompat.checkSelfPermission(getApplicationContext(),
                        Manifest.permission.CALL_PHONE) == PackageManager.PERMISSION_GRANTED) {
                    Intent callIntent = new Intent(Intent.ACTION_CALL);
                    callIntent.setData(Uri.parse("tel:09260887036"));
                  startActivity(callIntent);
                }else{
                    Toast.makeText(getApplicationContext(), "You don't assign permission.", Toast.LENGTH_SHORT).show();
                }
    ...
    public void map(){
        ...
        cinname.setText(R.string.msanlo);
        dialog.show();
        dialog.setCanceledOnTouchOutside(true);
